...
describe('DaTitle', () => {
  ...
  describe('handleAction (preview/publish)', () => {
    ...
    function buildEl(opts = {}) {
      ...
      element._aemHrefs = {
        preview: { origin: 'https://main--site--org.ent-aem.page' },
        prod: { origin: 'https://main--site--org.ent-aem.live' },
      };
    ...
    it('Preview path: opens the preview URL on success', async () => {
      ...
      window.fetch = () => Promise.resolve(new Response(
        JSON.stringify({
          preview: { url: 'https://main--site--org.ent-aem.page/test/page' },
          webPath: '/test/page',
        }),
        { status: 200 },
      ));
  ...
  describe('sidekickCacheBust', () => {
    ...
    it('Returns immediately when window.chrome is missing', async () => {
      ...
      const element = new DaTitle();
      // Should not throw
      await element.sidekickCacheBust('https://main--site--org.ent-aem.live/page');
    });
    ...
    it('Sends a cache-bust message to the configured extension id', async () => {
      ...
      expect(captured.opts.host).to.equal('main--site--org.ent-aem.live');
    });
