  ...
  describe('saveOffer', () => {
    it('POSTs to create and returns success/offerId', async () => {
      ...
      const result = await saveOffer(
        ...
        'My Offer',
        '<p>hello</p>',
        'https://main--repo--org.ent-aem.page/path',
        'Joe',
      );
      ...
      expect(body.marketingCloudMetadata.editURL).to.equal(
        'https://ent-da.live/edit#/org/repo/path',
      );
    ...
    it('PUTs to update when offerId is provided', async () => {
      ...
      const result = await saveOffer(config, 'n', 'c', 'https://main--r--o.ent-aem.page/p', 'd', 'oid');
    ...
    it('Returns the error text when not ok', async () => {
      ...
      const result = await saveOffer(config, 'n', 'c', 'https://main--r--o.ent-aem.page/p', 'd');
